...
enum phb4_state {
	...
	/* Hot reset */
	PHB4_STATE_HRESET_DELAY,
	PHB4_STATE_HRESET_DELAY2,

	/* Fundamental reset */
	PHB4_STATE_FRESET_ASSERT_DELAY,
	PHB4_STATE_FRESET_DEASSERT_DELAY,

	/* Complete reset */
	PHB4_STATE_CRESET_WAIT_CQ,
	PHB4_STATE_CRESET_REINIT,
	PHB4_STATE_CRESET_FRESET,

	/* Link state machine */
	PHB4_STATE_WAIT_LINK_ELECTRICAL,
	PHB4_STATE_WAIT_LINK,
};
...
#define PHB4_RESTORE_BUS_NUM	0x00000008
#define PHB4_CAPP_RECOVERY	0x00000010
